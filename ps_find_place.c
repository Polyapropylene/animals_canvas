...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/22 21:32:26 by rrhyhorn          #+#    #+#             */
/*   Updated: 2022/03/28 20:18:29 by rrhyhorn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static int	smaller_element_detection(t_stack *a, int buff, int src)
{
	t_stack	*save;
	int		ret;
...
static void	help_finding_place(t_stacks *s,

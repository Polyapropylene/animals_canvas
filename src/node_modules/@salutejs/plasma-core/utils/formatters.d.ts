...
export declare const padZeroNumber: (value: number) => string;
/**
 ...
 */
export declare const monthName: (val: number, monthFormat: Intl.DateTimeFormatOptions['month']) => string;
export declare const monthLongName: (val: number) => string;
export declare const monthShortName: (val: number) => string;

...
export declare type ToIndex = (i: number) => void;
export declare type ToPrev = () => void;
export declare type ToNext = () => void;
...
export declare type CarouselProps = BasicProps & (DetectionProps | NoDetectionProps);
export declare type UseCarouselOptions = Pick<CarouselProps, 'index' | 'axis' | 'detectActive' | 'detectThreshold' | 'scrollAlign' | 'scaleCallback' | 'scaleResetCallback' | 'onIndexChange' | 'onDetectActiveItem' | 'animatedScrollByIndex' | 'throttleMs' | 'debounceMs'>;
export declare type UseCarouselLiteOptions = Pick<CarouselLiteProps, 'index' | 'axis' | 'scrollAlign' | 'scrollMode'>;
export declare type CarouselTemplateProps = Omit<BasicProps, Exclude<keyof UseCarouselOptions, 'axis'>>;
export declare type CarouselVirtualProps = {
    /**

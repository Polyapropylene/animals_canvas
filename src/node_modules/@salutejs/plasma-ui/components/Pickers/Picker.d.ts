 ...
 */
export declare const Picker: ({ id, size, value, items, controls, autofocus, visibleItems, scrollSnapType, "aria-label": ariaLabel, onChange, ...rest }: PickerProps) => JSX.Element;

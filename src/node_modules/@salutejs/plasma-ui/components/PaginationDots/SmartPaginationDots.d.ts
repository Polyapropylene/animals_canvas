...
import { SmartPaginationDotsProps as BaseProps } from '@salutejs/plasma-core';
 ...
 */
export declare const SmartPaginationDots: ({ items, index, visibleItems, ...rest }: SmartPaginationDotsProps) => JSX.Element;

...
export var Slider = function Slider(_ref) {
  ...
  var onFirstHandleChangeCommited = React.useCallback(function (handleValue, data) {
  ...
  var onSecondHandleChangeCommited = React.useCallback(function (handleValue, data) {

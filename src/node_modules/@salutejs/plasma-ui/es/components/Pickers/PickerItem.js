...
})(["position:relative;box-sizing:border-box;overflow:hidden;display:flex;align-items:center;text-align:center;width:100%;color:", ";cursor:pointer;user-select:none;", " &:focus{outline:0 none;background:none;}", " ", ""], tertiary, function (_ref) {
  var $noScrollBehavior = _ref.$noScrollBehavior;
  return !$noScrollBehavior && css(["scroll-snap-align:center;"]);
}, function (_ref2) {
...
var StyledTransformable = /*#__PURE__*/styled.div.withConfig({
  ...
  return !$noScrollBehavior && css(["transition:", ";transform:translate3d(0,0,0);"], function (_ref5) {
...
export var PickerItem = function PickerItem(_ref6) {

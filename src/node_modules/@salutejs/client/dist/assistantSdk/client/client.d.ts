import { SystemMessageDataType, OriginalMessageType, AppInfo, HistoryMessages, Meta } from '../../typings';
...
export declare const createClient: (protocol: ReturnType<typeof createProtocol>, provideMeta?: (() => Promise<Meta>) | undefined) => {
    destroy: () => void;
    init: () => Promise<void>;
    ...
    sendData: (data: Record<string, unknown>, messageName?: string, meta?: Meta | undefined) => number | Long;

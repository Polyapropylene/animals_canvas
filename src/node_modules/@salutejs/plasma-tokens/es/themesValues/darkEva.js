...
export var accent = '#129DFA';
/** Акцентный цвет у контролов */
export var buttonAccent = '#078CE4';
/** Цвет рамки фокуса у контрола */
export var buttonFocused = 'rgba(255, 255, 255, 0.96)';
/** Градиент для заливки основного фона */
export var gradient = 'linear-gradient(336.9deg, #143787 0%, rgba(8, 8, 8, 0) 64.95%), radial-gradient(66.53% 100% at 73.33% 100%, rgba(110, 5, 193, 0.44) 0%, rgba(53, 19, 149, 0.1) 99.69%), linear-gradient(180.03deg, rgba(8, 8, 8, 0) 50%, rgba(25, 63, 152, 0.41) 99.97%), linear-gradient(270deg, rgba(39, 15, 107, 0.3) 0%, rgba(8, 8, 8, 0) 100%)';
/** Градиент для заливки основного фона */
export var gradientDevice = 'linear-gradient(26.05deg, rgba(26, 140, 255, 0.16) 0%, rgba(8, 8, 8, 0) 72.24%), radial-gradient(100% 100% at 0% 100%, rgba(0, 85, 255, 0.28) 0%, rgba(8, 8, 8, 0) 99.69%), radial-gradient(74.68% 149.35% at 50% 149.35%, rgba(128, 0, 255, 0.48) 0%, rgba(8, 8, 8, 0) 99.69%)';
/** Градиент подсказок о голосовых запросах */
export var voicePhraseGradient = 'linear-gradient(45deg, hsla(200.11764705882354, 94.44444444444446%, 64.70588235294117%, 1) 0%, hsla(240, 100%, 83.92156862745098%, 1) 100%)';
//# sourceMappingURL=darkEva.js.map